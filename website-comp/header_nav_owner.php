        ...
        <div style="max-width: none;"><a class="navbar-brand js-scroll-trigger" href="#"
            ...
            <div class="dropdown show" style="float: right;margin-top: 15px;"><a class="dropdown-toggle"
                ...
                <div class="dropdown-menu dropdown-menu-left" role="menu"
                    ...
                    <a class="dropdown-item text-info" role="presentation" href="">STORE MANAGER</a>
                    <a class="dropdown-item text-info" role="presentation" href="php/session_destroy.php"?>LOGOUT</a></div>
            </div>
        </div>
    </div>
</nav>