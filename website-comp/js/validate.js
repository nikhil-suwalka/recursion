...
{
    flag101 = 0;
    var lname = document.data.confirm_pwd.value;
...
function funConfirm() {
    flag102 = 0;
    var password2 = document.data.password.value;;
    var confpassword = document.data.confirm_pwd.value;
...
function fun81() {
    flag103 = 0;
    var ph = document.data.contact.value;
    if (ph == '') {
        document.getElementById("contactval").innerHTML = "<span style=\"color: red; font-size: 12px \"> Contact field cannot be empty </span>";
        $(".contactval").show();
    } else if (ph.match(/[^0-9+]/))
    {
        document.getElementById("contactval").innerHTML = "<span style=\"color: red; font-size: 12px \"> Only Numbers  </span>";
        $(".contactval").show();
    } else {
        flag103 = 1;
        $(".contactval").hide();
